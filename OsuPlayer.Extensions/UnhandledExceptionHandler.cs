...
public static class UnhandledExceptionHandler
{
    ...
    public static void HandleException(Exception ex)
    {
        ...
        var crashlog =
            "A shit, it looks like you did something that the Music Player for osu! did not like. If you think this is a bug, please report this crashlog to the GitHub by using the buttons below! (Also please don't forget to state how you achieved the crash e. g. what did you do, click etc.)"
            + Environment.NewLine
            + Environment.NewLine
