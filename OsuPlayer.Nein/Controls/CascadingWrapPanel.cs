...
public class CascadingWrapPanel : Panel, INavigableContainer
{
    ...
    protected override Size MeasureOverride(Size constraint)
    {
        ...
        _lineCount = (int) Round((parameters.IsHorizontal ? constraint.Width : constraint.Height) /
                                 (parameters.IsHorizontal ? parameters.ItemWidth : parameters.ItemHeight));
    ...
    protected override Size ArrangeOverride(Size finalSize)
    {
        ...
        _lineCount = (int) Round((parameters.IsHorizontal ? finalSize.Width : finalSize.Height) /
                                 (parameters.IsHorizontal ? parameters.ItemWidth : parameters.ItemHeight));
